        ...
        <FadeIn>
            ...
            <div className="flex items-center gap-4">
              {socialLinks.map((link) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="w-10 h-10 glass rounded-xl flex items-center justify-center text-dark-400 hover:text-blue-400 transition-colors border border-white/5 hover:border-blue-500/30"
          ...
          <div className="border-t border-white/5 mt-8 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-dark-600 text-sm">
              © {new Date().getFullYear()} Jair Alvarenga Pereira. Todos os direitos reservados.
            </p>
            <p className="text-dark-600 text-sm">
              Desenvolvido com{' '}
              <span className="text-blue-500">Next.js</span>,{' '}
              <span className="text-blue-500">Tailwind CSS</span> e{' '}
              <span className="text-blue-500">Framer Motion</span>
            </p>
          </div>
        </FadeIn>
      </div>
