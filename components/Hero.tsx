        ...
        <div>
            ...
            >
              <a
                href="/jairap-dev.pdf"
                download
                className="group relative inline-flex items-center gap-2 px-5 py-3 md:px-8 md:py-4 bg-blue-600 text-white font-medium rounded-xl transition-all duration-300 hover:bg-blue-500 hover:shadow-xl hover:shadow-blue-500/25"
              >
              ...
              <a
                href="#contato"
                className="inline-flex items-center gap-2 px-5 py-3 md:px-8 md:py-4 glass text-white font-medium rounded-xl transition-all duration-300 hover:bg-white/10 border border-white/10"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
